Rails.application.routes.draw do
  ...
  get("/delete_director/:a_director_id", {:controller => "directors", :action => "destroy" })
  post("/update_director_record/:a_director_id", {:controller => "directors", :action => "update" })
  ...
  get("/delete_actor/:an_actor_id", {:controller => "actors", :action => "destroy" })
  post("/update_actor_record/:an_actor_id", {:controller => "actors", :action => "update" })
